			...
			<div class="row">
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart"><div></div>
						<?php $total = 0;?>
                        @if(count($products) != 0)
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="/shop/{{ $product->thumb }}" alt="{{ $product->name }}">
										</div>
									</td>
									<td class="column-2">{{ $product->name }}</td>
									<td class="column-3">{{ number_format(App\Helpers\Helper::price($product->price, $product->price_sale)) }}VNĐ</td>
									<td class="column-4">
                        ...
                        @else
                            <div class="text-center bg0 p-t-100 p-b-85"><h2>Giỏ hàng còn trống</h2></div>
                        @endif
						</div>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							<div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
								<div class="p-t-15">
									...
									<div class="bor8 bg0 m-b-12">
										<textarea class="cl8 plh3 size-111 p-lr-15" name="content">Ghi Chú</textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-check mb-3">
							...
							<label class="form-check-label" for="creditCard">Thanh toán bằng tiền mặt</label>
						</div>

						<div class="form-check mb-3">
							<input class="form-check-input" type="radio" name="payment_method" id="paypal" value="momo">
						...
						<br>
						<button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" name="payUrl">
							Thanh Toán
						</button>
					</div>
				</div>
